...
- class: Workflow
  ...
  inputs:
    study_area_west: float
    study_area_south: float
    study_area_east: float
    study_area_north: float
    cloud_cover_max:
      type: int
      default: 20
    days_back:
  ...
  steps:
    mangrove_analysis:
      ...
      in:
        study_area_west: study_area_west
        study_area_south: study_area_south
        study_area_east: study_area_east
        study_area_north: study_area_north
